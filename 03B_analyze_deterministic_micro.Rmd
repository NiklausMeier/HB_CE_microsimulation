...
pandoc.table(summary_table_undisc_ETRANACOGENE_PROPHYLAXIS, "Comparison undiscounted outcomes between ETRANACOGENE and Prophylaxis", style = 'rmarkdown')
...
pandoc.table(summary_table_costs, "Undiscounted costs broken down by category", style = 'rmarkdown')
...
pandoc.table(summary_table_costs, "Discounted costs broken down by category", style = 'rmarkdown')
